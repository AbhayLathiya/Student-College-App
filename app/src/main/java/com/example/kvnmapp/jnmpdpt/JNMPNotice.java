...
public class JNMPNotice extends AppCompatActivity {


    private RecyclerView deleteNoticeRecycler;
    private ProgressBar progressBar;
    private ArrayList<NoticeData> list;
    private JNMPNoticeAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("JnmpNotice");
        ...
        titleTextView.setText("JNMP Notice");
    ...
    private void getNotice() {
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new JNMPNoticeAdapter(JNMPNotice.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                progressBar.setVisibility(View.GONE);
                Toast.makeText(JNMPNotice.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
