...
public class BCPNoticeAdapter extends RecyclerView.Adapter<BCPNoticeAdapter.NoticeViewAdapter> {
    private final Context context;
    private final ArrayList<NoticeData> list;
    public BCPNoticeAdapter(Context context, ArrayList<NoticeData> list) {
    ...
    @NonNull
    @Override
    public BCPNoticeAdapter.NoticeViewAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.newsfeed_item_layout, parent, false);
        return new NoticeViewAdapter(view);
    }

    @Override
    public void onBindViewHolder(@NonNull BCPNoticeAdapter.NoticeViewAdapter holder, int position) {
